        ...
        public static async Task Main(string[] args)
        {
            ...
            switch (example)
            {
                case nameof(BasicExample):
                    ...
                    break;
                case nameof(ConnectToGossipNetwork):
                    await ConnectToGossipNetwork.Main(args);
                    break;
                ...
                case nameof(LogicSignatureExample):
                    ...
                    break;
                case nameof(FalconAccountExample):
                    await FalconAccountExample.Main(args);
                    break;
                case nameof(FalconKeyInteropExample):
                    await FalconKeyInteropExample.Main(args);
                    break;
